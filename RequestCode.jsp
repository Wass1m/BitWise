...
melbourne 005</p>
             ...
             <p>Email: info@example.com</p>
              ...
              <li class="col-md-4">
                ...
                <hr>
                <p>get <span>$25 OFF</span>  Any 
Tankless Water Heater Installation</p>


<a href="#." class="btn">view our specials</a>
              </li>
            </ul>
         ...
         <div class="contact-form">
          ...
          <div class="tittle"><h2>RESET PASSWORD  </h2>
				<hr>
              <p>Type in the email linked to your account</p>
          </div>
          
          
          
            <form role="form" action="SendCode.jsp"  >
              <ul class="row">
                ...
                <li class="col-sm-12">
                  <button type="submit" value="submit" class="btn" id="btn_submit" >Request Code</button>
                </li>
              </ul>
            </form>
          </div>
