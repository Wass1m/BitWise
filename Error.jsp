...
<div id="wrap"> 
    ...
    <div class="container"> 
      ...
      <div class="header-contact">
        <ul class="row">
          <li class="col-xs-6"> <i class="fa fa-home"></i>
            <p class="exo">44 new design street
              melbourne 005</p>
          </li>
          <li class="col-xs-6"> <i class="fa fa-phone"></i>
            <h6>+61 (123) 456 789</h6>
            <p class="exo">info@example.com</p>
          </li>
        </ul>
      </div>
      ...
      <nav> 
        ...
        <ul class="ownmenu">
          ...
          <li  class="active"><a href="03-About.html">About Us </a></li>
  ...
  <div class="sub-banner">
    <div class="container">
      ...
      <p class="exo"><% String x = (String) session.getAttribute("message");
          out.print(x);%></a></p>
      <p class="exo">Sorry for the inconviniance get back <a href="index.jsp">home?</a></p>
    </div>
    <ol class="breadcrumb">
