...
<div id="wrap"> 
  ...
  <div class="sub-banner">
    <div class="container">
      ...
      <p class="exo">we have 25 years exerience in plimbing</p>
    </div>
    <ol class="breadcrumb">
      <li><a href="#">home </a></li>
...
of all our offers</p>
         ...
         <div class="contact-form">
          ...
          <div class="tittle"><h2>Activate Your Account  </h2>
				<hr>
              <p>Please check type in your Email and the activation code that you recieved</p>
          </div>
          
          
          
            <form role="form" action="Activation.jsp"  >
              <ul class="row">
                
                
                <li class="col-sm-12">
                <label>Your Email
                      <input type="email" class="form-control" name="email" id="email" placeholder="">                </li>
                      <li class="col-sm-12">
                <label>Your Activation Code
                      <input type="text" class="form-control" name="code" id="email" placeholder="">                </li>
                <li class="col-sm-12">
                  <button type="submit" value="submit" class="btn" id="btn_submit" >Activate Your Account</button>
                </li>
              </ul>
            </form>
          </div>
