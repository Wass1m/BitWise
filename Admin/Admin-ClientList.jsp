...
%>
        ...
        <div class="container">
            <ul class="row">
                <li class="col-sm-8">
                    ...
                    <!--======= BLOG POST=========-->
                    <div class="blog-post"> <img class="img-responsive" src="images/clients.jpg" alt="" > <span class="date"><i class="fa fa-clock-o"></i> <%= new Date() %></span> <a class="title-hed">know more about our clients</a>
    ...
    <table  id="clients" class="table table-striped table-bordered  table-hover table-inverse" cellspacing="0" width="100%">
        <thead>
        <tr>
            <th>Client ID</th>
            <th>Type</th>
        ...
        <%
            ...
            try{
                ...
                // RECUPERATION DES INFOS CLIENTS POUR LA LISTE
                ResultSet rs1= st1.executeQuery("select * from client");
                while(rs1.next()){
        ...
        <tr>
            ...
            <td><%=rs1.getString("avis")%></td>
            <td>
                                <button type="button"    class="btn btn-sm btn-default" style="padding-right:10px;padding-left:10px " data-toggle="modal" data-target="#ID01"  onclick='window.open("./Functions/Admin-Feedback.jsp?state=agree&id=<%=rs1.getString("IDclient")%>");'>APPROVE </button>
                                <button type="button"   class="btn btn-sm btn-default" style="padding-right:10px;padding-left:10px " data-toggle="modal" data-target="#ID01"  onclick='window.open("./Functions/Admin-Feedback.jsp?state=disagree&id=<%=rs1.getString("IDclient")%>");'>DISAPPROVE </button>

                <button type="button" style="padding-right:10px;padding-left:10px "  class="btn btn-sm btn-default" data-toggle="modal" data-target="#ID01"  onclick="document.getElementById('IDC').value='<%=rs1.getString("IDident")%>'">Archive</button>
            </td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Archivage Client</h4>
      </div>
        
            
      <div class="modal-body">
          <p style="color:red;"><b>Voulez vous vraiment archiver ce Client ?!<b></p>
