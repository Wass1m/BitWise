    ...
    function loadXMLDoc1()
    {
        ...
        xmlhttp.onreadystatechange=function()
        {
            if (xmlhttp.readyState===4)
            {
                ...
                if(document.getElementById("err1").innerHTML.includes("Free") && document.getElementById("err2").innerHTML.includes("available")){document.getElementById("mySubmit").disabled = false;}
 ...
 var st = document.getElementById("mySubmit");
        ...
        xmlhttp.onreadystatechange=function()
        {
            if (xmlhttp.readyState===4)
            {
                ...
                else if(!(document.getElementById("err2").innerHTML.includes("Taken")) && (document.getElementById("occupe").innerHTML.includes("non"))) document.getElementById("mySubmit").disabled = false;
...
function checkPass()
{
    ...
    if(pass1.value === pass2.value){
        ...
        if(document.getElementById("err1").innerHTML.includes("Free")) document.getElementById("mySubmit").disabled = false;
    }else{
