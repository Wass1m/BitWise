...
<div id="wrap">
    ...
    <div class="sub-banner">
        <div class="container">
            <h1>WELCOME <%=rs.getString("Prenom")%> <%=rs.getString("Nom")%></h1>
            <p class="exo">You will find here all the  informations that concerns your affectations</p>
        </div>
        <ol class="breadcrumb">
            <li><a href="#">home </a></li>
    ...
    <div class="call-inner">
      <div class="container">
        <h1>Check Your affectations</h1>
        <BR>
        <BR>
         <a  class="posit"  href="Admin-ContratInterv.jsp"><img src="../images/contract.png"></a>
      </div>
    </div>
  </section>      
