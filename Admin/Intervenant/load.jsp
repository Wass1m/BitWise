...
rsi = st.executeQuery("select * from notification n INNER JOIN contrat c on c.IDcontrat=n.IDcontrat INNER JOIN planning p on p.IDcontrat = n.IDcontrat INNER JOIN intervenant i on i.IDintervenant=p.IDintervenant WHERE i.IDintervenant="+idi+" AND n.type='Intervenant' ");
...
rsi = st.executeQuery("select * from notification n INNER JOIN CONTRAT c on c.IDcontrat=n.IDcontrat INNER JOIN client cl on cl.IDclient=c.IDclient WHERE cl.IDclient="+idi+" AND n.type='Client' ");
